...
Chest::Chest(char type) {
    if (type == 'C') {
        ...
        items =  {"Celestia, Might of the Empty Void", "Iron Axe","Iron Axe","Iron Axe","Iron Axe","Iron Axe","Iron Axe","Iron Axe","Iron Axe","Iron Axe","Iron Axe", "Long Sword","Long Sword","Long Sword","Long Sword","Long Sword","Long Sword","Long Sword","Long Sword","Long Sword","Long Sword","Long Sword","Long Sword","Long Sword", "Brutality, Doomblade of Horrid Dreams", "Basic Dagger", "Wooden Bow", "Knife","Knife","Knife","Knife","Knife", "Phantomsong, Bauble of Illuminated Dreams", "Sword", "Wooden Spear","Wooden Spear","Wooden Spear","Wooden Spear","Wooden Spear","Wooden Spear","Wooden Spear", "Gloves", "Gandiva, The Invincible Bow of Brahma", "Vijaya, The Divine Bow"};
    } else if (type == 'A') {
        // Initialize chest with weapons only
